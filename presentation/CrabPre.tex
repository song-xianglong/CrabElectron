...
\title{\textbf{\textbf{From Multiwavelenth Data to Electron Distribution}}}
        ...
        \begin{frame}
            \begin{figure}[t]
                ...
                \begin{subfigure}{0.6\linewidth}
                    \centering
                    \includegraphics[width=\linewidth]{SynIC-BestFitPar4.pdf}
                    \caption{}
                \end{subfigure}
                \begin{subfigure}{0.3\textwidth}
                    \centering
                    \includegraphics[width=\linewidth]{SynIC-BestFitPar4-2.pdf}
                    \caption{}
                \end{subfigure}
