...
import naima
from naima.models import ExponentialCutoffPowerLaw, InverseCompton, Synchrotron, ExponentialCutoffBrokenPowerLaw, ExponentialCutoffDoubleBrokenPowerLaw
...
def lnprior(pars):
    ...
    logprob = (
        ...
        + naima.uniform_prior(pars[2], np.log10(0.1), np.log10(10))
...
if __name__ == "__main__":
    ...
    p0 = np.array((36.67, np.log10(0.265), np.log10(100), 1.5, 3.2, 3.4, np.log10(1863.0), B0))
    labels = ["log10(norm)", "log10(e_break1)", "log10(e_break2)", "alpha_1", "alpha_2", "alpha_3", "log10(cutoff)", "B"]
