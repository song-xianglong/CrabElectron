...
import naima
from naima.models import ExponentialCutoffPowerLaw, InverseCompton, Synchrotron, Bremsstrahlung, PionDecay, ExponentialCutoffBrokenPowerLaw
...
e_break = FitPar['median'][3] * u.TeV
alpha_1 = FitPar['median'][4]
alpha_2 = FitPar['median'][5]
e_cutoff = FitPar['median'][7] * u.TeV
B = FitPar['median'][8] * u.uG
We = FitPar['median'][9] * u.erg
#Model
ECPL = ExponentialCutoffBrokenPowerLaw(amplitude, 1.0 * u.TeV, e_break, alpha_1, alpha_2, e_cutoff)
